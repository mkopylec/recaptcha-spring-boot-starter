...
public final class Strings {
    ...
    public static final String WEBMVC_SPRING_PROFILE = "webmvc";
    public static final String WEBFLUX_SPRING_PROFILE = "webflux";
    ...
    public static final String RESPONSE_DATA_MESSAGE = "I am response";
